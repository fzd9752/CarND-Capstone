...
Final project for 3-term Udacity-CarND by individualy. Achieve the basic requiremnts that integrating `control`, `path_planning` and `traffic light detection` modules into a *Autoware* based ROS. The code cand drive the car smoothly following the lane and safely stoping in front of a red traffic light in the sumulator Highway road.
...
[Here](Video/example.mp4) is the example video of this project.
